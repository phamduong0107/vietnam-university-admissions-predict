...
Mô hình Chênh lệch (Delta/Residual Model): Học độ dao động biến thiên (
Δ
Δ) so với điểm chuẩn năm ngoái để bắt được sự nhạy cảm vi mô của Phổ điểm và Chỉ tiêu.
Bộ nội suy Tuyến tính (Linear Blending): Sử dụng thuật toán Grid-Search 1D để tìm ra Tỷ lệ vàng 
α
α nhằm hòa trộn khuyết điểm của cả 2 mô hình trên, mang lại Sai số MAE cực tiểu.
...
Tịnh tiến Thời gian (Time-shifting): "Giáng cấp" dữ liệu hiện tại thành 
t
−
1
t−1 (Ví dụ: Biến điểm chuẩn 2025 thành thuộc tính diem_nam_ngoai cho năm 2026).
